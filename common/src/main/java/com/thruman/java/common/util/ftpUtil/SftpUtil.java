package com.thruman.java.common.util.ftpUtil;
...
public class SftpUtil {
     ...
     * @throws Exception 异常
     */
    public static void uploadFile(final String srcFile, final String desFile, final ChannelSftp sftp) throws Exception {
        try {
            File file = new File(srcFile);
            if (file.exists()) {
                List<String> list = formatPath(desFile);
    ...
    public static void main(String[] args) throws Exception {
        ChannelSftp sftp = getSftpConnect("xjyc-svr1", 22, "xjycsvr1", "su*3373J631F");
        String pathString = "D:/Users/yaoyuping/Desktop/CustomerInfo_20171117_dat.txt";
//        File file = new File(pathString);
        System.out.println("上传文件开始...");
        uploadFile(pathString, "/data/shared_files/ftpData/1234.txt", sftp);
