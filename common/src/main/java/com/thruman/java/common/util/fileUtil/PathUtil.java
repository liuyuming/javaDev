...
//			return new File(path).getParentFile().getParentFile().getCanonicalPath();
			...
			//        String strPath = System.getProperty("user.dir");//user.dir指定了当前的路径
//        File directory = new File("");//设定为当前文件夹
//        strPath = directory.getCanonicalPath();
//        strPath = directory.getAbsolutePath();
//        strPath = Class.class.getClass().getResource("/").getPath();
//        strPath = request.getSession().getServletContext().getRealPath("");
//			String strPath = Class.class.getClass().getResource("/").getPath();
			return "";
		} catch (Exception e) {
